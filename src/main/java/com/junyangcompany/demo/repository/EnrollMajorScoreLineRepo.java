...
public interface EnrollMajorScoreLineRepo extends JpaRepository<EnrollMajorScoreLine, Long>, JpaSpecificationExecutor<EnrollMajorScoreLine> {
    ...
    @Query(value = "select new com.junyangcompany.demo.entity.professerEntity.QueryEnrollCollegeMajorBean_demo(a.id,a.maxScore,a.minScore,a.minRank,a.averageScore,a.enrollCount,a.scoreLineDiff,a.year,a.price,a.name,b.yearOfStudy,b.enrollBatch,b.enrollCollege)" +
